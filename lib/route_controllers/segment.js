...
SegmentDetailController = RouteController.extend({
  ...
  data: function () {
    ...
    if (self.ready()) {
      ...
      var graphListData = SegmentGraphs.findOne(_.extend({}, selector, {graphType: SegmentGraphBase.Graph.List})).data;
      var graphVisitorsXDatesData = SegmentGraphs.findOne(_.extend({}, selector, {graphType: SegmentGraphBase.Graph.VisitorsXDates})).data;
      var graphVisitorsXDwellData = SegmentGraphs.findOne(_.extend({}, selector, {graphType: SegmentGraphBase.Graph.VisitorsXDwell})).data;
      var graphVisitorsXVisitsData = SegmentGraphs.findOne(_.extend({}, selector, {graphType: SegmentGraphBase.Graph.VisitorsXVisits})).data;
      var graphDistributionDwellEnterData = SegmentGraphs.findOne(_.extend({}, selector, {graphType: SegmentGraphBase.Graph.DistributionDwellEnter})).data;
      var graphDistributionVisitsEnterData = SegmentGraphs.findOne(_.extend({}, selector, {graphType: SegmentGraphBase.Graph.DistributionVisitsEnter})).data;
      var graphDistributionVisitsExitData = SegmentGraphs.findOne(_.extend({}, selector, {graphType: SegmentGraphBase.Graph.DistributionVisitsExit})).data;
      var graphTopLocationsVisitorsData = SegmentGraphs.findOne(_.extend({}, selector, {graphType: SegmentGraphBase.Graph.TopLocationsVisitors})).data;
      var graphTopLocationsDwellData = SegmentGraphs.findOne(_.extend({}, selector, {graphType: SegmentGraphBase.Graph.TopLocationsDwell})).data;
      var graphTopLocationsVisitsData = SegmentGraphs.findOne(_.extend({}, selector, {graphType: SegmentGraphBase.Graph.TopLocationsVisits})).data;
      var graphOtherSegmentsData = SegmentGraphs.findOne(_.extend({}, selector, {graphType: SegmentGraphBase.Graph.OtherSegments})).data;
