...
SegmentDetailController = RouteController.extend({
  ...
  data: function () {
    ...
    if (self.ready()) {
      ...
      _.each(visitorTopLocationsBarChart.data, function(item) {
        return _.extend(item, {percent: item.count/max});
      });
      ...
      _.each(dwellTimeTopLocationsBarChart.data, function(item) {
        return _.extend(item, {percent: item.duration/max});
      });
      ...
      _.each(numberOfVisitTopLocationsBarChart.data, function(item) {
        return _.extend(item, {percent: item.count/max});
      });
      ...
      data = _.extend(data, {
        ...
        visitorTopLocationsBarChart: visitorTopLocationsBarChart.data,
        dwellTimeTopLocationsBarChart: dwellTimeTopLocationsBarChart.data,
        numberOfVisitTopLocationsBarChart: numberOfVisitTopLocationsBarChart.data,
