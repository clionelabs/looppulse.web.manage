  ...
  action: function () {
    ...
    if (this.ready()) {
      var polling = function() {
        Meteor.call("genSegmentListData", self.data().from, self.data().to, function(err, res){
          if (err) {
  ...
  action: function () {
    ...
    if (this.ready()) {
      var polling = function() {
        ...
        Meteor.call("genSegmentData", segmentId, self.data().from, self.data().to, function(err, res){
          if (err) {
