...
ShowViewController = AdminController.extend({
  // Return Data
  // data: function(){
...
CreateViewController = AdminController.extend({
  template: "create_view"
})
UpdateViewController = AdminController.extend({
...
Router.map(function() {
  ...
  this.route('admin_company_show', {
    ...
    yieldTemplates:{
      "hello" : { to: "show-view-header" },
      "admin_collection_actions": { to: "show-row-prepend" }
    }
  });
