...
WelcomeEngagement.prototype.enteringTriggerInstallation = function (encounter) {
  return (encounter.isEnter() && this.atTriggerInstallation(encounter));
}
...
WelcomeEngagement.prototype.readyToTrigger = function (encounter) {
  var self = this;
  if ( self.enteringTriggerInstallation(encounter) &&
