 ...
 * @returns {boolean}
 */
BaseEngagement.prototype.readyToTriggerByTime = function(time) {
  if (!this.validPeriod) {
    return true;
  }
  ...
  return (this.readyToTriggerByStartEnd(this.validPeriod.start, this.validPeriod.end, now) &&
          this.readyToTriggerByDayOfWeek(this.validPeriod.dayOfWeek, now) &&
          this.readyToTriggerByTimePeriods(this.validPeriod.timePeriods, now));
};

BaseEngagement.prototype.readyToTriggerByStartEnd = function(start, end, now) {
...
BaseEngagement.prototype.readyToTriggerByDayOfWeek = function(dayOfWeek, now) {
...
BaseEngagement.prototype.readyToTriggerByTimePeriods = function(timePeriods, now) {
