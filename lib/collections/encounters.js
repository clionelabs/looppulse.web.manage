...
Encounter.prototype.findBeaconEvents = function() {
...
Encounter.prototype.isQualified = function() {
  var expectedProximity = 3;  // CLProximityImmediate | CLProximityNear
  var quality = 0;
  this.findBeaconEvents().forEach(function(beaconEvent) {
    if (beaconEvent.proximity === expectedProximity) {
      quality += 1;
    }
  });
  return quality >= 2;
