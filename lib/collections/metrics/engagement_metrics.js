...
EngagementMetric.prototype.conversionRate = function() {
  return BaseMetric.calculateConversionRate(this.sentMessageCount, this.visitedCount);
};

EngagementMetric.prototype.sentMessageViewedConversionRate = function() {
  return BaseMetric.calculateConversionRate(this.sentMessageCount, this.viewedMessageCount);
};

EngagementMetric.prototype.viewedMessageVisitedConversionRate = function() {
  return BaseMetric.calculateConversionRate(this.viewedMessageCount, this.visitedCount);
};
...
var handleEncounterAdded = function(encounter) {
  ...
  Engagement.availableEngagements(locationId).forEach(function(engagement) {
    ...
    var hasMeesage = Messages.findOne({
