...
BaseMetric.calculateChangePercentage = function(currentCount, pastCount) {
  return BaseMetric.calculatePercentage(currentCount - pastCount, pastCount);
};

BaseMetric.convertMillisecondsToMinutes = function(milliseconds) {
