Metrics = new Meteor.Collection("metrics", {
  transform: function (doc) {
    switch (doc.type) {
      case EngagementMetric.type:
        return new EngagementMetric(doc);
      case InstallationMetric.type:
        return new InstallationMetric(doc);
      case ProductMetric.type:
        return new ProductMetric(doc);
      case SegmentMetric.type:
        return new SegmentMetric(doc);
      case VisitorMetric.type:
        return new VisitorMetric(doc);
      default:
